...
* Challenge 3 (Net Salary Calculator):
  - In line 136, `console.log(netSalaryCalculator(25000, 3000, "2023-01-10", "yearly"));`<br>replace each of the 3 arguments in this order: `(Salary, benefits, "Date", "monthly/yearly")` with its actual values  
